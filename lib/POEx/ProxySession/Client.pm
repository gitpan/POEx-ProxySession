...
=head2 subscriptions metaclass => MooseX::AttributeHelpers::Collection::Hash
...
=head2 publications metaclass => MooseX::AttributeHelpers::Collection::Hash
...
=head2 actice_connectios



=head2 unknown_message_event is: 'rw', isa: Tuple[SessionID|SessionAlias, Str]
...
=head2 socket_error_event is: 'rw', isa: Tuple[SessionID|SessionAlias, Str]
...
=head2 connect_error_event is: 'rw', isa: Tuple[SessionID|SessionAlias, Str]
...
=head2 handle_inbound_data(ProxyMessage $data, WheelID $id) is Event
...
=head2 around connect(Str :$remote_address,Int :$remote_port, SessionAlias|SessionID|Session|DoesSessionInstantiation :$return_session?,Str :$return_event,Ref :$tag?) is Event
...
=head2 after handle_on_connect(GlobRef $socket, Str $address, Int $port, WheelID $id) is Event
...
=head2 after handle_socket_error(Str $action, Int $code, Str $message, WheelID $id) is Event




=head2 after handle_connect_error(Str $action, Int $code, Str $message, WheelID $id) is Event




=head2 subscribe(WheelID :$connection_id, SessionAlias :$to_session, SessionAlias|SessionID|Session|DoesSessionInstantiation :$return_session?,Str :$return_event, Ref :$tag?) is Event
...
=head2 unsubscribe(SessionAlias :$session_name, SessionAlias|SessionID|Session|DoesSessionInstantiation :$return_session?, Str :$return_event, Ref :$tag) is Event
...
=head2 publish(WheelID :$connection_id, SessionAlias :$session_alias, DoesSessionInstantiation :$session, SessionAlias|SessionID|Session|DoesSessionInstantiation :$return_session?, Str :$return_event, Ref :$tag?) is Event
...
=head2 rescind(DoesSessionInstantiation :$session, SessionAlias|SessionID|Session|DoesSessionInstantiation :$return_session?, Str :$return_event, Ref :$tag?) is Event
...
=head2 server_listing(WheelID :$connection_id, SessionAlias|SessionID|Session|DoesSessionInstantiation :$return_session?, Str :$return_event, Ref :$tag?) is Event
